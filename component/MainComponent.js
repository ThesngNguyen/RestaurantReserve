...
// import OurHistory from './OurHistoryComponent';
...
function ContactUsNavigatorScreen() {
  ...
  return (
    <ContactUsNavigator.Navigator
      ...
      <ContactUsNavigator.Screen name='Contact' component={ContactUs}
        options={({ navigation }) => ({
          headerTitle: 'Contact',
          headerLeft: () => (<Icon name='menu' size={36} color='#fff' onPress={() => navigation.toggleDrawer()} />)
        })} />
...
function MainNavigatorScreen() {
  ...
  return (
    <MainNavigator.Navigator initialRouteName='HomeScreen' drawerContent={(props) => <CustomDrawerContent {...props} />}>
      ...
      <MainNavigator.Screen name='ContactScreen' component={ContactUsNavigatorScreen}
        options={{
  ...
  return (
    <DrawerContentScrollView {...props}>
      <View style={{ backgroundColor: '#7cc', height: 80, alignItems: 'center', flexDirection: 'row' }}>
        ...
        <View style={{ flex: 2 }}>
          <Text style={{ color: '#fff', fontSize: 22, fontWeight: 'bold' }}>Thangws & Friends</Text>  
        </View>
      </View>
